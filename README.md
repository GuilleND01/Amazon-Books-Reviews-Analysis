...
- [**booksPriceEvolution.py**](/scripts/booksPriceEvolution.py): Muestra la evolución de los precios de los libros en un intervalo de tiempo
- [**categoryPriceEvolution.py**](/scripts/categoryPriceEvolution.py): Muestra la evolucion del precio de lo libros de una categoría en un intervalo
